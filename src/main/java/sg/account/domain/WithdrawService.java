...
class WithdrawService {
    ...
    public WithdrawService(AccountRepositoryPort accountRepositoryPort, DatePort datePort, FxRatePort fxRatePort) {
    ...
    void withdraw(AccountIdDto accountId, AmountDto amount) {
        ...
        account.withdraw(retrieveAmount(account, amount), dateOfTransaction);
